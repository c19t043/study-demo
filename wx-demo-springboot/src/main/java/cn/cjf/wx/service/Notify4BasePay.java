...
import cn.cjf.wx.model.MchInfo;
import cn.cjf.wx.model.PayOrder;
import cn.cjf.wx.mq.Mq4PayNotify;
import cn.cjf.wx.utils.PayDigestUtil;
import cn.cjf.wx.utils.XXPayUtil;
...
public class Notify4BasePay extends BaseService {
	...
	public String createNotifyUrl(PayOrder payOrder, String backType) {
		...
		Map<String, Object> paramMap = new HashMap<>(ConstantConfig.MAP_INITIAL_CAPACITY);
		// 支付订单号
