 ...
 * @author CJF
 */
public class SingleChatStartCommandHandle implements BaseHandle {

//    /**
//     * 单聊开始命令：
//     * 1、客户端接受到单聊命令，向服务端发送单聊命令
//     * 2、服务端收到命令，并绑定，向客户端响应：单聊命令绑定成功
//     * 3、客户端收到响应答应消息，客服端提示：请输入要聊天的内容；格式：要聊天的客户【userId:[用户id]:消息】
//     * 4、客户端接收到内容，向服务端发送消息
//     * 5、服务端查看何种命令，如果绑定了单聊命令，将受到的消息转发给指定的客户端
