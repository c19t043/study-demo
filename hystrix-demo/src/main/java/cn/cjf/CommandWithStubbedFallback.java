...
public class CommandWithStubbedFallback extends HystrixCommand<CommandWithStubbedFallback.UserAccount> {
    ...
    @Override
    protected CommandWithStubbedFallback.UserAccount run() {
    ...
    @Override
    protected CommandWithStubbedFallback.UserAccount getFallback() {
        /**
         * Return stubbed fallback with some static defaults, placeholders,
         * and an injected value 'countryCodeFromGeoLookup' that we'll use
         * instead of what we would have retrieved from the remote service.
         */
        return new CommandWithStubbedFallback.UserAccount(customerId, "Unknown Name",
