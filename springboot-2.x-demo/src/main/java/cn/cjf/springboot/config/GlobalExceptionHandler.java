...
import cn.cjf.springboot.exception.CustomException;
import cn.cjf.springboot.exception.ErrorResponseEntity;
 ...
 * 注解就可以定义出异常通知类了，然后在定义的方法中添加上 @ExceptionHandler 即可实现异常的捕捉…
 */
