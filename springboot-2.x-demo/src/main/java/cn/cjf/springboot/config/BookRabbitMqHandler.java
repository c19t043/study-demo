 ...
 */
@Component
public class BookRabbitMqHandler {

    private static final Logger log = LoggerFactory.getLogger(BookRabbitMqHandler.class);
    ...
    public void listenerAutoAck(BookRabbitMq book, Message message, Channel channel) {
    ...
    public void listenerManualAck(BookRabbitMq book, Message message, Channel channel) {
    ...
    public void listenerDelayQueue(BookRabbitMq book, Message message, Channel channel) {
