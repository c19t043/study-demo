...
import cn.cjf.springboot.entity.UserShiro;
...
public class DBCache {
     ...
     * V 用户信息
     */
    public static final Map<String, UserShiro> USERS_CACHE = new HashMap<>();
    /**
     * K 角色ID
     * V 权限编码
     */
    ...
    static {
        // TODO 假设这是数据库记录
        USERS_CACHE.put("u1", new UserShiro(1L, "u1", "p1", "admin", true));
        USERS_CACHE.put("u2", new UserShiro(2L, "u2", "p2", "admin", false));
        USERS_CACHE.put("u3", new UserShiro(3L, "u3", "p3", "test", true));
