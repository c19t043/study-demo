...
public class ZxingUtils {
    ...
    /**
     * 将内容content生成指定长宽的图片流
     */
    public static BufferedImage createImage(String contents, int length, int width) throws WriterException {
        Map<EncodeHintType, Object> hints = new Hashtable<>();
        hints.put(EncodeHintType.ERROR_CORRECTION, ErrorCorrectionLevel.M);
        hints.put(EncodeHintType.CHARACTER_SET, "UTF8");

        BitMatrix bitMatrix = new MultiFormatWriter().encode(contents, BarcodeFormat.QR_CODE, width, length, hints);
