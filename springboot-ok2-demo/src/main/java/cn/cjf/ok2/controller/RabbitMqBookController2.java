...
public class RabbitMqBookController2 {

    private static final Logger log = LoggerFactory.getLogger(RabbitMqBookController2.class);

    private final RabbitTemplate rabbitTemplate;

    @Autowired
    public RabbitMqBookController2(RabbitTemplate rabbitTemplate) {
    ...
    public void defaultMessage() {
        ...
        this.rabbitTemplate.convertAndSend(RabbitConfig.REGISTER_DELAY_EXCHANGE, RabbitConfig.DELAY_ROUTING_KEY, book, message -> {
            ...
            message.getMessageProperties().setHeader(AbstractJavaTypeMapper.DEFAULT_CONTENT_CLASSID_FIELD_NAME, RabbitMqBook.class.getName());
