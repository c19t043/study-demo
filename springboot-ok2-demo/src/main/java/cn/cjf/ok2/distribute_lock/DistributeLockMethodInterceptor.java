package cn.cjf.ok2.distribute_lock;
...
public class DistributeLockMethodInterceptor {
    ...
    @Autowired
    public DistributeLockMethodInterceptor(StringRedisTemplate lockRedisTemplate, CacheKeyGenerator cacheKeyGenerator) {
    ...
    @Around("execution(public * *(..)) && @annotation(cn.cjf.ok2.distribute_lock.CacheLock)")
