...
public class BookHandler {
    ...
    public void listenerAutoAck(RabbitMqBook book, Message message, Channel channel) {
    ...
    public void listenerManualAck(RabbitMqBook book, Message message, Channel channel) {
    ...
    public void listenerDelayQueue(RabbitMqBook book, Message message, Channel channel) {
