...
@ContextConfiguration(locations = { "/dubbo-consumer.xml" })
...
public class DubboConsumerBeanMockingTest {
    ...
    public static void mockDubbo() {
        // 你准备mock哪个消费bean
        // 比如要对dubbo-consumber.xml里配置的cn.cjf.jmockit.MailService这个消费bean进行mock
        Map<String, Object> mockMap = new HashMap<String, Object>();
        mockMap.put("cn.cjf.jmockit.MailService", new MockUp(MailService.class) {
