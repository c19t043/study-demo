...
public class MockitDemo {
    ...
    /**
     * 2.11 用spy监控真实对象
     * Mock不是真实的对象，它只是用类型的class创建了一个虚拟对象，不可以设置对象行为
    ...
    public void spy_on_real_objects() {
        ...
        //下面预设的spy.get(2)会报错，因为会调用真实对象的get(2)，所以会抛出越界异常
        spy.get(2);
    }
...
//        verify(comparator).compare(anyString(),"hello");
    ...
    private class IsValid extends ArgumentMatcher<Integer> {
        ...
        public boolean matches(Object o) {
            return o == Integer.valueOf(1) || o == Integer.valueOf(2);
        }
    }
