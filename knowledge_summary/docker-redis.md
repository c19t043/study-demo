...
+ `docker run -p 6379:6379 --rm --name redis -d redis:3.2 `
### 有配置文件

> docker run -p 6379:6379 --rm --name redis -v /usr/local/app/redis.conf:/etc/redis/redis.conf -v /usr/local/app/redis/data:/data -d redis:3.2 redis-server /etc/redis/redis.conf --appendonly yes

+ `docker run -p 6379:6379 --rm --name redis -v $PWD/redis.conf:/etc/redis/redis.conf -v $PWD/data:/data -d redis:3.2 redis-server /etc/redis/redis.conf --appendonly yes`
